...
public class Workload extends AbstractType {
    ...
    @JsonProperty("replicaSetConfig")
    private ReplicaSetConfig replicaSetConfig;

    @JsonProperty("replicaSetStatus")
    ...
    @JsonProperty("statefulSetConfig")
    private StatefulSetConfig statefulSetConfig;

    @JsonProperty("statefulSetStatus")
